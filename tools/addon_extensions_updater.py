...
#      manifest from the current set of addons, plus the non-addon extensions
#      listed in EXTRA_EXTENSIONS (bdj). Both blocks must sit at the end of the
#      manifest, after modules:.
#
...
# non-addon extensions, emitted verbatim ahead of the addon entries
EXTRA_EXTENSIONS = """\
  tv.kodi.Kodi.bdj:
